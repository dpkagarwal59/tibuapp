...
class StripeBloc {
  ...
  Future<void> stripeKeys(BuildContext context) async {
    ...
    _repository.getStripeKeys().then((Response response) async {
      ...
      StripeResponseModel stripeResponseModel = StripeResponseModel.fromJson(json.decode(response.body));
      ...
      loaderController.add(false);
      debugPrint('get stripe response exception is -------->  ${error.toString()}');

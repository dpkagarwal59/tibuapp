...
// //var BASE = 'https://tibu.teaseme.co.in/app/';
// class ClubApp {
//   static String app_name = 'TIBU';
//   static String name = 'TIBU';
//
//
...
//   //String weburl = '${BASE_URL}app-test';
...
//   static String Proceed_to_pay = 'Proceed To Pay';
...
class ClubApp {
  ...
  static String address_empty_msg = 'Please enter address';
  static String sign_up = 'Sign Up';
  static String package1 = 'Remove package';

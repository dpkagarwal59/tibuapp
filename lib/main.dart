    ...
    return OverlaySupport.global(
      ...
      theme: ThemeData(
          ...
          textTheme: const TextTheme(
            // Text size 20
            headline6: TextStyle(fontWeight: FontWeight.w500, color: colorPrimaryDark),
            // Text size 14
            subtitle2: TextStyle(fontWeight: FontWeight.w500),
            // Text size 16
            subtitle1: TextStyle(fontWeight: FontWeight.normal, color: Colors.black),
            // Text size 14
            bodyText2: TextStyle(fontWeight: FontWeight.normal, color: Colors.black),
            // Text size 14
            bodyText1: TextStyle(fontWeight: FontWeight.w500, color: Colors.black),
            // Text size 12
            caption: TextStyle(fontWeight: FontWeight.normal, color: Colors.black),
            // Text size 10
            overline: TextStyle(fontWeight: FontWeight.normal, color: Colors.black),
            // Text size 13
            headline5: TextStyle(fontWeight: FontWeight.bold, color: Colors.black, fontSize: 14.0),
          )),
      home: SplashScreen(),
      // home: Success(),
